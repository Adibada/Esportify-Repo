...
-- Import data for evenements (with adjusted columns)
INSERT INTO evenements (id, organisateur_id, titre, description, start, end, statut, lot, image) VALUES 
(1,1,'La baston vidéoludique !','La bagarre pixelisée !','2025-09-03 14:35:15','2025-09-06 14:35:15','termine','Trophée doré',''),
(2,1,'Un super Event !','Cet évènement va être vraiment génial!','2025-09-04 16:17:15','2025-09-30 16:17:15','demarre','Prix spécial',''),
(3,1,'L\'évènement de l\'année !','Un futur classique, c\'est sûr ','2025-09-04 16:19:03','2025-09-06 16:19:03','termine','Médaille d\'or',''),
(4,1,'Battle Royal','Batailles épiques en perspective !','2025-10-01 19:00:00','2025-10-01 23:30:00','valide','Couronnes royales',''),
...
INSERT INTO participations (user_id, evenements_id, statut, rang) VALUES 
(1,1,'valide',400),
(1,2,'valide',NULL),
(1,43,'valide',NULL),
(1,44,'valide',NULL),
